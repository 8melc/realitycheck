...
const toneTexts: ToneTexts = {
  ...
  conversationSubtitle: {
    straight: 'Frag den Reality Check Guide etwas – deine Gespräche werden hier gespeichert.',
  ...
  journeySubtitle: {
    straight: 'Deine letzten Schritte in Reality Check – damit dein Momentum sichtbar bleibt.',
